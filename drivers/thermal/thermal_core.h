...
#ifdef CONFIG_THERMAL_GOV_PD
int thermal_gov_pd_register(void);
void thermal_gov_pd_unregister(void);
#else
static inline int thermal_gov_pd_register(void) { return 0; }
static inline void thermal_gov_pd_unregister(void) {}
#endif /* CONFIG_THERMAL_GOV_PD */
